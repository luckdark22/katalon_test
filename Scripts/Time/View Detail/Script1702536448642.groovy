...
WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Username_username'), 'smith')

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/div_View'))
